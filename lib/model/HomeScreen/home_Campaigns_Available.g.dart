...
part of home_Campaigns_Available;

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<HomeCampaignsAvailableModel>
    _$homeCampaignsAvailableModelSerializer =
    new _$HomeCampaignsAvailableModelSerializer();

class _$HomeCampaignsAvailableModelSerializer
    implements StructuredSerializer<HomeCampaignsAvailableModel> {
  @override
  final Iterable<Type> types = const [
    HomeCampaignsAvailableModel,
    _$HomeCampaignsAvailableModel
  ];
  @override
  final String wireName = 'HomeCampaignsAvailableModel';

  @override
  Iterable<Object?> serialize(
      Serializers serializers, HomeCampaignsAvailableModel object,
  ...
  @override
  HomeCampaignsAvailableModel deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new HomeCampaignsAvailableModelBuilder();
...
class _$HomeCampaignsAvailableModel extends HomeCampaignsAvailableModel {
  @override
  final int? id;
  @override
  final int? price;
  ...
  factory _$HomeCampaignsAvailableModel(
          [void Function(HomeCampaignsAvailableModelBuilder)? updates]) =>
      (new HomeCampaignsAvailableModelBuilder()..update(updates)).build();

  _$HomeCampaignsAvailableModel._(
      {this.id,
      this.price,
      this.discount,
      this.campaign_image,
  ...
  @override
  HomeCampaignsAvailableModel rebuild(
          void Function(HomeCampaignsAvailableModelBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  HomeCampaignsAvailableModelBuilder toBuilder() =>
      new HomeCampaignsAvailableModelBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is HomeCampaignsAvailableModel &&
        id == other.id &&
        price == other.price &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper('HomeCampaignsAvailableModel')
          ..add('id', id)
          ..add('price', price)
...
class HomeCampaignsAvailableModelBuilder
    implements
        Builder<HomeCampaignsAvailableModel,
            HomeCampaignsAvailableModelBuilder> {
  _$HomeCampaignsAvailableModel? _$v;
  ...
  HomeCampaignsAvailableModelBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
      _id = $v.id;
      _price = $v.price;
  ...
  @override
  void replace(HomeCampaignsAvailableModel other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$HomeCampaignsAvailableModel;
  }

  @override
  void update(void Function(HomeCampaignsAvailableModelBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  _$HomeCampaignsAvailableModel build() {
    final _$result = _$v ??
        new _$HomeCampaignsAvailableModel._(
            id: id,
            price: price,
            discount: discount,
